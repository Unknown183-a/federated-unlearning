"""Run the real (non-pipeline-validation) FL experiment: CIFAR-100 + ResNet-18.

This produces M_old — the base federated model that Phase 04-07's
unlearning methods are compared against.

Usage:
    python experiments/run_cifar100_fl.py --config configs/cifar100_fl.yaml
"""
...
def main(config_path: str) -> None:
    ...
    train_set, test_set = get_cifar100_datasets(cfg.data.data_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="configs/cifar100_fl.yaml")
